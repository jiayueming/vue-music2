...
export default {
  ...
  methods: {
    ...
    onShortcutTouchStart (e) {
      // e.target指的是该对象里的子对象，也是触发这个事件的对象,e.target这里便是触发点击事件的li元素
      let anchorIndex = getData(e.target, 'index')
      console.log(anchorIndex)
      let firstTouch = e.touches[0] // 第一次touch记录位置
    ...
    onShortcutTouchMove (e) {
      ...
      // this.touch.anchorIndex是getAttrbuite获取的值为string
